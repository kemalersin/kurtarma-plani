...
[![Sürüm](https://img.shields.io/github/package-json/v/kemalersin/kurtarma-plani?label=sürüm)](package.json)
...
**Sürüm:** [package.json](package.json) (`version` alanı; canlı derlemede **Hakkında** ekranında görünür).
